...
do
    for target in "ChestX" #"ChestX" "CropDisease" "ISIC" 
    do
        ...
        --model resnet18 \
        --embedding_load_path  /home/oyallon/muawiz/FewShotMedical/fewshot_medical_imaging/fewshot_medical_imaging/BMS/logs/ImageNet/checkpoint_best.pkl \
