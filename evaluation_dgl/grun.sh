...
do
    ...
    do
        # TODO: Please set the following argument appropriately "ChestX" "ChestX"   
	...
	--freeze_backbone \
        ...
        --model vgg11 \
        --embedding_load_path  /local/oyallon/muawiz/models/checkpoints/miniImageNet/VGG11_dgl_baseline_128_aug/399.tar\
