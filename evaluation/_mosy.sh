...
do
    for target in "ISIC" "ChestX"  #"CropDisease" "CropDisease" "EuroSAT"
    do
        ...
        --model resnet10 \
        --embedding_load_path  /home/oyallon/muawiz/FewShotMedical/fewshot_medical_imaging/fewshot_medical_imaging/STARTUP/evaluation/model_fulldata/399.tar \
