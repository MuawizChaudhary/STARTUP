...
do  
    ...
    --num_workers 4 \
    --model resnet10 \
    --teacher_path /home/muawiz/fewshot_medical_imaging/STARTUP/teacher_miniImageNet/logs_deterministic/checkpoints/miniImageNet/ResNet10_baseline_256_aug/399.tar \
    --teacher_path_version 0 \
    --base_dataset miniImageNet \
    --base_path /home/muawiz/fewshot_medical_imaging/data/miniImagenet/miniImagenet \
